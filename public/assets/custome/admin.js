$(document).ready(function(){
    ...
    $(".item_edit").on('click', function(e){
        ...
        var itemNepaliName = $(this).data('nepaliname');
        // alert(itemNepaliName)
        var entryrates = $(this).data('entryrates');
        var exitsrates = $(this).data('exitsrates');
        var defaultunits = $(this).data('defaultunits');
        ...
        $('#item_edit_model').find("input[name='nepali_name']").val(itemNepaliName);
        $('#item_edit_model').find("input[name='entry_rates']").val(entryrates);
        $('#item_edit_model').find("input[name='exits_rates']").val(exitsrates);
        ...
        $("#units_option_update option").each(function(i){
            // alert(defaultunits)
            // alert($(this).val())
            if($(this).val() == defaultunits)
            {
                $('#units_option_update option[value="' + $(this).val() + '"]').attr('selected','selected');
    ...
    $(".units_edit").on('click', function(e){
        ...
        var UnitsNepaliName = $(this).data('nepaliname');

        //insert display message to the delete confirmation modal
        $('#units_edit_model').find("input[name='units_id']").val(UnitsId);
        $('#units_edit_model').find("input[name='name']").val(UnitsName);
        $('#units_edit_model').find("input[name='nepali_name']").val(UnitsNepaliName);
