...
@section('content')
	<form class="form-inline" method="post"  action="<?php echo url('/bill-edit-process') ?>" enctype="multipart/form-data" id="billPage">
		...
		<div class="row">
			...
			<div class="col-sm-4">
				<div class="form-group">
				    ...
				    <input type="text" class="form-control" name="date" value="<?php echo $bill_detail->entry_date;  ?>" required>eg 2074-12-30(YYYY-MM-DD)
