...
@endif
  ...
  Note: 1 foot == 12 inch
    ...
    <!-- <button class="btn btn-primary btn-xs" data-toggle="modal" data-target="#units_add_model">Add units</button> -->
    <?php } ?>
					...
					foreach($units as $unit)
					{
						?>
							<tr>
								...
								<!-- <td> -->
                                    <?php //if(Auth::user()->type == 1){ ?>
									   <!-- <button class="btn btn-info btn-xs units_edit" data-id="<?php echo $unit->id; ?>" data-name="<?php echo $unit->name; ?>"   >Edit</button> -->
